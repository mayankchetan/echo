...
---------------------- INPUT FILES ---------------------------------------------
"simpleTurbine_ElastoDyn_BDoutputs.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"simpleTurbine_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"simpleTurbine_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"simpleTurbine_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
"simpleTurbine_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)

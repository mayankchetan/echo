...
fname_wt_input = mydir + os.sep + "simpleTurbine_blade.yaml"
fname_modeling_options = mydir + os.sep + "modeling_blade.yaml"
fname_analysis_options = mydir + os.sep + "analysis_blade.yaml"
